...
class Activate {
	public static function activate() {
		...
		if ( ! get_option( 'buy_now_pay_later' ) ) {
			update_option( 'buy_now_pay_later', [] );
		}

		add_filter( 'init', 'bnpl_wc_register_post_statuses' );
	}

	// Register New Order Statuses
	public function bnpl_wc_register_post_statuses() {
