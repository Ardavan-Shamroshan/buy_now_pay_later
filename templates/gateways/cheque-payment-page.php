<div id="bnpl-container" class="my-2">
    <input type="hidden" name="bnpl_order_total" value="<?= $order->get_total() ?>">
        ...
        <form id="loading-container" method="post" action="" enctype="multipart/form-data" class="grid bg-white max-w-2xl grid-cols-1 p-5 mx-auto border shadow-md gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10 rounded-xl shadow-indigo-500/20"
            ...
            <div class="lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
                <div class="w-full" id="bnpl_installments_container">
                    <!--                    <div id="notice-message" class="bg-teal-100 border-t-4 border-teal-500 mb-2 p-1 px-2 rounded-lg shadow-md text-teal-900" role="alert" style="border: 1px solid #16d068">-->
                    <div id="notice-message" role="alert">
                        <div class="flex">
                            <div id="notice-message-svg-container">
                        ...
                        <div class="flex mb-4 flex-col cursor-pointer ">
                            <div id="drop-zone" class="w-full h-48 border-2 border-dashed border-gray-300 rounded-lg flex flex-col justify-center items-center text-gray-400 text-lg hover:bg-gray-100">
                                ...
                                <label for="file-input"
                                       class="rounded-md bg-indigo-600 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                    انتخاب کنید</label>
                                <input id="file-input" type="file" multiple class="hidden " name="bnpl_cheque_image[]"/>
                            </div>
                ...
                <div class="flex items-center justify-end mt-6 gap-x-2">
                    <button type="submit" name="bnpl_submit" value="bnpl_submit"
